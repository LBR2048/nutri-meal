...
import ardjomand.leonardo.nutrimeal.data.WidgetRepository;
import ardjomand.leonardo.nutrimeal.data.WidgetRepositoryImpl;
...
public class CustomerOrdersRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public void onCreate() {
        repository = new WidgetRepositoryImpl();
    }
...
//        loadDummyData();
    ...
    private void loadData() {
        repository.loadCustomerOrders(new WidgetRepository.LoadCustomersOrdersCallback() {
            @Override
